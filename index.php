    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                <a class="navbar-brand"><img src="pictures/logo.png" alt="Logo ballon"></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Saison actuelle</h3><!-- /.menu-title -->
                    <li>
                    ...
                    <h3 class="menu-title">Saisons antérieures</h3><!-- /.menu-title -->
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    </aside><!-- /#left-panel -->
